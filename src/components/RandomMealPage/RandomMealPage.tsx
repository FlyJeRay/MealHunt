  ...
  const displayPulledMeal = (): JSX.Element | null => {
    if (meal.meals[0].idMeal !== '-1') {
      ...
      const ingredients: { amount: string, name: string }[] = [
        { amount: checkedMeal.strMeasure1, name: checkedMeal.strIngredient1.charAt(0).toUpperCase() + checkedMeal.strIngredient1.slice(1) },
        { amount: checkedMeal.strMeasure2, name: checkedMeal.strIngredient2.charAt(0).toUpperCase() + checkedMeal.strIngredient2.slice(1) },
        { amount: checkedMeal.strMeasure3, name: checkedMeal.strIngredient3.charAt(0).toUpperCase() + checkedMeal.strIngredient3.slice(1) },
        { amount: checkedMeal.strMeasure4, name: checkedMeal.strIngredient4.charAt(0).toUpperCase() + checkedMeal.strIngredient4.slice(1) },
        { amount: checkedMeal.strMeasure5, name: checkedMeal.strIngredient5.charAt(0).toUpperCase() + checkedMeal.strIngredient5.slice(1) },
        { amount: checkedMeal.strMeasure6, name: checkedMeal.strIngredient6.charAt(0).toUpperCase() + checkedMeal.strIngredient6.slice(1) },
        { amount: checkedMeal.strMeasure7, name: checkedMeal.strIngredient7.charAt(0).toUpperCase() + checkedMeal.strIngredient7.slice(1) },
        { amount: checkedMeal.strMeasure8, name: checkedMeal.strIngredient8.charAt(0).toUpperCase() + checkedMeal.strIngredient8.slice(1) },
        { amount: checkedMeal.strMeasure9, name: checkedMeal.strIngredient9.charAt(0).toUpperCase() + checkedMeal.strIngredient9.slice(1) },
        { amount: checkedMeal.strMeasure10, name: checkedMeal.strIngredient10.charAt(0).toUpperCase() + checkedMeal.strIngredient10.slice(1) },
        { amount: checkedMeal.strMeasure11, name: checkedMeal.strIngredient11.charAt(0).toUpperCase() + checkedMeal.strIngredient11.slice(1) },
        { amount: checkedMeal.strMeasure12, name: checkedMeal.strIngredient12.charAt(0).toUpperCase() + checkedMeal.strIngredient12.slice(1) },
        { amount: checkedMeal.strMeasure13, name: checkedMeal.strIngredient13.charAt(0).toUpperCase() + checkedMeal.strIngredient13.slice(1) },
        { amount: checkedMeal.strMeasure14, name: checkedMeal.strIngredient14.charAt(0).toUpperCase() + checkedMeal.strIngredient14.slice(1) },
        { amount: checkedMeal.strMeasure15, name: checkedMeal.strIngredient15.charAt(0).toUpperCase() + checkedMeal.strIngredient15.slice(1) },
        { amount: checkedMeal.strMeasure16, name: checkedMeal.strIngredient16.charAt(0).toUpperCase() + checkedMeal.strIngredient16.slice(1) },
        { amount: checkedMeal.strMeasure17, name: checkedMeal.strIngredient17.charAt(0).toUpperCase() + checkedMeal.strIngredient17.slice(1) },
        { amount: checkedMeal.strMeasure18, name: checkedMeal.strIngredient18.charAt(0).toUpperCase() + checkedMeal.strIngredient18.slice(1) },
        { amount: checkedMeal.strMeasure19, name: checkedMeal.strIngredient19.charAt(0).toUpperCase() + checkedMeal.strIngredient19.slice(1) },
        { amount: checkedMeal.strMeasure20, name: checkedMeal.strIngredient20.charAt(0).toUpperCase() + checkedMeal.strIngredient20.slice(1) }
      ]

      return (
        <div>
          <h2>{meal.meals[0].strMeal}</h2>
          <p>{meal.meals[0].strArea} {meal.meals[0].strCategory} meal</p>
          {
            meal.meals[0].strYoutube != '' ? <a href={meal.meals[0].strYoutube} target='_blank'>Check this meal on YouTube</a> : null
          }
          <p>Ingredients:</p>
          <ul>
            {
              ingredients.map(ing => {
                return( ing.amount > '' && ing.name > '' ? <li>{ing.name}: {ing.amount}</li> : null )
              })
            }
          </ul>
        </div>
